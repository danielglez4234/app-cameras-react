...
class UpdateCamera extends Component {
  ...
  getCameraById = (id) =>{
    ...
    axios.put("http://161.72.123.211:1026/v2/entities/"+ id,  { headers: options	})
      .then(response => {
      ...
      <form className="formCameras" action="/selectedCamera" method="get">
        ...
        <div className="omrs-input-group width-input-1">
          <label className="omrs-input-underlined label-input-idCamera">
            ...
            <input defaultValue={this.state.camera.idCam} required name="idCamera" className="width-input-1 border-radius-left-0 displayInlineBlock" />
        ...
        <div className="omrs-input-group margin-left-50">
          <label className="omrs-input-underlined">
            <input defaultValue={this.state.camera.name} required name="nameCamera"/>
        ...
        <div className="omrs-input-group displayInlineBlock">
          <label className="omrs-input-underlined">
            <input defaultValue={this.state.camera.url} required name="urlCamera" className="width-input-x2" />
        ...
        <div className="omrs-input-group displayBlock">
          <label className="omrs-input-underlined">
            <textarea defaultValue={this.state.camera.description} required name="description"></textarea>
